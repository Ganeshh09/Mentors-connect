  ...
  useEffect(() => {
    ...
    const data = async () => {
      const response = await axios.post(
        "https://mentors-connect-2-ai02.onrender.com/get-data_OAuth",
        { code: modifiedcode },
        {
  ...
  useEffect(() => {
    ...
    const newdata = async () => {
      const response2 = await axios.post(
        "https://mentors-connect-2-ai02.onrender.com/get-upcoming-events",
        { token, ownerlink },
        {
          withCredentials: true,
        }
      ...
      /* if (response2.data.length > 0) {
        ...
        const new_response = await axios.post(
          "https://mentors-connect-2-ai02.onrender.com/get-invitee-name",
          {
            uri_id,
            token,
          },
